...
public class StarRocksHandlerStrategy extends AbstractHandlerStrategy implements ServiceRoleStrategy {

    public StarRocksHandlerStrategy(String serviceName, String serviceRoleName) {
